...
using UnityEngine;
//15 8 (12)
public class City_Twelve : MonoBehaviour {
    ...
    SpriteRenderer Twelve;
    // Use this for initialization
    void Start () {
        Twelve = gameObject.GetComponent<SpriteRenderer>();
    ...
    private void OnMouseDown()
    {
        ...
        if (City_Fifteen.CityFifteen == 1)
        {
            Twelve.color = new Color(0f, 255f, 244f, 255f);
            CityTwelve = 1;
