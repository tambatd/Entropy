...
using UnityEngine;
//9 20 21 22 23 (17)
public class City_Seventeen : MonoBehaviour {
    ...
    SpriteRenderer Seventeen;
    public static int Money;

    // Use this for initialization
    void Start () {
		Seventeen = gameObject.GetComponent<SpriteRenderer>();
    ...
    private void OnMouseDown()
    {
        ...
        {
            Seventeen.color = new Color(0f, 255f, 244f, 255f);
            CitySeventeen = 1;
