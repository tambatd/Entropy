...
using UnityEngine;
//14 10 7 (11)
public class City_Eleven : MonoBehaviour {
    ...
    SpriteRenderer Eleven;
    // Use this for initialization
    void Start () {
        Eleven = gameObject.GetComponent<SpriteRenderer>();
    ...
    private void OnMouseDown()
    {
        ...
        else if (City_Fourteen.CityFifteen == 1)
        {
            Eleven.color = new Color(0f, 255f, 244f, 255f);
            CityEleven = 1;
