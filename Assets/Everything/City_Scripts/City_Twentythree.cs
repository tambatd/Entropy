...
using UnityEngine;
//22 24 17 (23)
public class City_Twentythree : MonoBehaviour {
    ...
    SpriteRenderer Twentythree;
    // Use this for initialization
    void Start () {
        Twentythree = gameObject.GetComponent<SpriteRenderer>();
    ...
    {
        if (CityTwentythree == 1)
        {
            Money_Int_Change.Money += 0;
        }
       else if (City_Twentytwo.CityTwentytwo == 1)
        {
            Twentythree.color = new Color(0f, 255f, 244f, 255f);
            CityTwentythree = 1;
